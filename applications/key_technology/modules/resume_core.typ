...
#let urbn_work = work(
    title: "Senior AI Engineer & Machine Learning Architect",
...
#let  pepsi_head_work = work(
    title: "Head of AI Engineering & Strategy, Generative AI, eCommerce",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let pepsi_principal_work = work(
    title: "Principal Machine Learning Engineer & AI Integrator, eCommerce",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let penn_work = work(
    title: "Senior Full-Stack ML Engineer & Lead Data Scientist",
    location: "Philadelphia, PA",
...
#let education_entries = {
  edu(
    ...
    location: "Philadelphia, PA",
    degree: "Master of Science, Statistics & Machine Learning",
  )

  edu(
    institution: "Lehigh University",
    location: "Bethlehem, PA",
    degree: "Bachelor of Arts, Economics & Computer Science",
  )
}
