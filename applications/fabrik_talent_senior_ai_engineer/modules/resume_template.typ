...
#let create_resume() = {
  ...
  [*Languages*: Python, C++, SQL, R, Haskell]
  
  [*Frameworks*: PyTorch, TensorFlow, DuckDB, Kubernetes, KubeFlow, Flyte]
  
  [*Performance Engineering*: High-throughput systems, Distributed computing, Model optimization, Profiling & benchmarking]
  
  [*ML Systems*: ML pipelines, Model deployment, GPU optimization, LLM inference, Generative AI]
