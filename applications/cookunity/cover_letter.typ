...
#show: coverletter.with(
  ...
  recipient: (
    ...
    institution: [CookUnity],
    address: [New York, NY],
    postcode: [],
    start-title: greeting("Hiring Manager"),
    cl-title: [RE: Senior Machine Learning Scientist, Recommendation and Search Systems],
  ),
)
...
#opening_paragraph("Senior Machine Learning Scientist, Recommendation and Search Systems", "CookUnity")

#body_paragraph

#company_specific_paragraph("CookUnity")
