...
// Core work experience entries (customized for recommendation systems focus)
#let urbn_work = work(
    title: "Senior Machine Learning Scientist, Recommendation Systems",
...
#let pepsi_head_work = work(
    title: "Head of Machine Learning Engineering & Recommendation Systems",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let pepsi_principal_work = work(
    title: "Principal Machine Learning Scientist, Search & Personalization",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let penn_work = work(
    title: "Lead Machine Learning Scientist, Recommendation Systems",
    location: "Philadelphia, PA",
...
#let heavywater_work = work(
    title: "Machine Learning Scientist, Search & Information Retrieval",
    location: "Philadelphia, PA",
    company: "Heavywater",
