...
// Core work experience entries (customized for Director position)
#let urbn_work = work(
    title: "Senior Machine Learning Architect & AI Strategy Lead",
...
#let pepsi_head_work = work(
    title: "Head of Machine Learning Engineering & AI Innovation",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let pepsi_principal_work = work(
    title: "Principal Data Scientist & AI/ML Technical Lead",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let penn_work = work(
    title: "Lead Data Scientist & ML Strategy Director",
    location: "Philadelphia, PA",
