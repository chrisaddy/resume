...
#let urbn_work = work(
    title: "Technical Lead Machine Learning Engineer & Architect",
...
#let  pepsi_head_work = work(
    title: "Head of ML Engineering & Technical Lead, Personalization",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let pepsi_principal_work = work(
    title: "Principal Machine Learning Engineer, Recommendation Systems",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let penn_work = work(
    title: "Lead Machine Learning Engineer, Personalization & Behavioral Modeling",
    location: "Philadelphia, PA",
