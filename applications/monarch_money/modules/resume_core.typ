...
// Core work experience entries (customized for GenAI and NLP focus)
#let urbn_work = work(
    title: "Principal Machine Learning Engineer, GenAI & NLP",
...
#let pepsi_head_work = work(
    title: "Head of Generative AI & Machine Learning Engineering",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let pepsi_principal_work = work(
    title: "Principal NLP Engineer & Machine Learning Scientist",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let penn_work = work(
    title: "Lead Machine Learning Engineer, Conversational AI",
    location: "Philadelphia, PA",
...
#let heavywater_work = work(
    title: "Machine Learning Engineer, Financial NLP",
    location: "Philadelphia, PA",
    company: "Heavywater",
