...
#show: coverletter.with(
  ...
  recipient: (
    ...
    institution: [Monarch Money],
    address: [Remote],
    postcode: [],
    start-title: greeting("Hiring Team"),
    cl-title: [RE: Software Engineer, Machine Learning (Senior/Staff/Principal)],
  ),
)
...
#opening_paragraph("Software Engineer, Machine Learning", "Monarch Money")

#body_paragraph

#company_specific_paragraph("Monarch Money")
