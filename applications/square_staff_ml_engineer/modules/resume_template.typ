...
#let create_resume() = {
  ...
  [== Summary]
  [Staff Machine Learning Engineer with 8+ years of experience in designing and implementing production-grade recommendation systems, churn prediction models, and generative AI solutions. Expert in end-to-end ML lifecycle from problem definition to production deployment. Proven track record of cross-functional leadership, setting engineering standards, and delivering measurable business impact through machine learning innovations.]
