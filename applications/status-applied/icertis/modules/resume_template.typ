...
#let create_resume(job_title: none, include_technical_skills: false) = {
  show: resume.with(
    author: name,
    // location: location,
    email: email,
  ...
  if job_title != none {
    [#text(weight: "bold", size: 1.2em)[#job_title]\ ]
  }

  // Technical Skills section if requested
  if include_technical_skills {
    [== Technical Skills]
    [- #technical_skills.at(0)]
    [- #technical_skills.at(1)]
    [- #technical_skills.at(2)]
    [- #technical_skills.at(3)]
    []
  }
