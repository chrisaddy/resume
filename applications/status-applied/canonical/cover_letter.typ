...
#show: coverletter.with(
  ...
  recipient: (
    ...
    institution: [Canonical Ltd.],
    address: [],
    postcode: [],
    start-title: greeting("Hiring Manager"),
    cl-title: [Application: Engineering Manager - MLOps & Analytics],
  ),
)
...
#opening_paragraph("Engineering Manager - MLOps & Analytics", "Canonical")

#body_paragraph

#company_specific_paragraph("Canonical")
