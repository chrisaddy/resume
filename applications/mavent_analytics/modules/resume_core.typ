...
#let urbn_work = work(
    title: "Principal Machine Learning Engineer & Architect",
...
#let  pepsi_head_work = work(
    title: "Head of Machine Learning Engineering & MLOps, Generative AI",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let pepsi_principal_work = work(
    title: "Principal Machine Learning Engineer, eCommerce",
    location: "Philadelphia, PA",
    company: "Pepsico",
...
#let penn_work = work(
    title: "Lead Machine Learning Engineer & Data Scientist",
    location: "Philadelphia, PA",
